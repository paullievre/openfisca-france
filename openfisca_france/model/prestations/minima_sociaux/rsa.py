...
@reference_formula
class has_enfant_moins_3_ans(SimpleFormulaColumn):
    column = BoolCol
    label = u"Existence d'un enfant de strictement moins de 3 ans dans la famille"
    entity_class = Familles
...
class rsa_majore_eligibilite(SimpleFormulaColumn):
    ...
    def function(self, simulation, period):
        ...
        enfant_moins_3_ans = simulation.calculate('has_enfant_moins_3_ans', period)
        ...
        eligib = (
            ...
            (enfant_moins_3_ans | isolement_recent) *
            rsa_eligibilite_tns
        )
